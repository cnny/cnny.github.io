...
**[在这里预览模板 &rarr;](http://imcnny.com/huxblog-boilerplate/)**
...
```
# Site settings
title: Yuu Blog             # 你的博客网站标题
SEOTitle: Yuu Blog			# 在后面会详细谈到
...
看右边:
![](http://imcnny.com/img/blog-sidebar.jpg)
...
![](http://imcnny.com/img/blog-keynote.jpg)
...
---
layout:     keynote
iframe:     "http://imcnny.com/js-module-7day/"
---
```
...
ga_domain: imcnny.com			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“Yuu Blog”** 但是我想要在搜索的时候显示 **“黄玄的博客 | Yuu Blog”** ，这个就需要SEO Title来定义了。
